...
<script src="<?php echo base_url() ?>assets/assets/plugins/bootstrap-select2/select2.min.js"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/classie/classie.js"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/switchery/js/switchery.min.js" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/nvd3/lib/d3.v3.js" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/nvd3/nv.d3.min.js" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/nvd3/src/utils.js" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/nvd3/src/tooltip.js" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/nvd3/src/interactiveLayer.js" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/assets/plugins/nvd3/src/models/axis.js" type="text/javascript"></script>
...
<script src="<?php echo base_url() ?>assets/assets/plugins/mapplic/js/hammer.js"></script>
...
<script src="<?php echo base_url() ?>assets/assets/plugins/rickshaw/rickshaw.min.js"></script>
...
<script src="<?php echo base_url() ?>assets/assets/js/demo.js" type="text/javascript"></script>
