...
================================================== -->
		...
		<div class="row">
			...
			<div class="col-md-4 animated fadeInRight notransition">
				...
				<p>
					 A little note here for contact, A little note here for contact, A little note here for contact, A little note here for contact, A little note here for contact, A little note here for contact, A little note here for contact, A little note here for contact,
				</p>
				<h4 class="font100">The Office</h4>
				<ul class="unstyled">
					<li><span style="margin-right:5px;"><i class="icon-map-marker"></i></span> Address: 56, Gbagada Road, Lagos</li>
					<li><span style="margin-right:3px;"><i class="icon-phone"></i></span> Phone: 08175020329</li>
					<li><span style="margin-right:2px;"><i class="icon-envelope"></i></span> Email: <a href="mailto:vadeshayo@gmail.com">vadeshayo@gmail.com</a></li>
				</ul>
				<h4 class="font100">Business Hours</h4>
				<ul class="unstyled">
					<li><i class="icon-time"></i> Monday - Friday 9am to 7pm</li>
