  ...
  <div>
    ...
    <div class="login-container bg-white">
      <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
        ...
        <p class="p-t-35"><?php echo lang('reset_password_heading');?></p>
        <?php echo $message;?>
        <form id="reset" class="p-t-15" role="form" action="<?php echo site_url('auth/reset_password/'.$code) ?>" method="post">
