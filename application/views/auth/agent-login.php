  ...
  <div class="login-wrapper ">
    ...
    <div class="login-container bg-white">
      <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
        ...
        <form id="form-login" class="p-t-15" role="form" action="<?php echo site_url('auth/agent_login') ?>" method="post">

          <div class="form-group form-group-default">
            <label>Phone</label>
            <div class="controls">
              <input type="text" name="agent_phone" placeholder="phone" class="form-control" required>
            </div>
          </div>
